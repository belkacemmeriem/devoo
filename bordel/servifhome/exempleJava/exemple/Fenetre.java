...
public class Fenetre {
	...
	public Fenetre(int largeur, int hauteur) {
		// Creation d'un cadre de fenetre contenant un menu, deux boutons, 
		// un ecouteur de souris (affichant un message quand la souris est cliquee)
		// et une zone de dessin
		fenetre = new JFrame("Mon application");
		fenetre.setLayout(null);
		fenetre.setSize(largeur,hauteur);
		fenetre.addMouseListener(new MouseAdapter(){
			public void mouseClicked(MouseEvent e){System.out.println("Souris cliquée en x="+e.getX()+" y="+e.getY());}
		});
		creeMenu();
	...
	private void creeMenu(){
		...
		ActionListener a1 = new ActionListener(){public void actionPerformed(ActionEvent e){dessin.setCouleurArrierePlan(Color.blue); dessin.repaint();}};
		ajoutItem("Bleu", menuCouleurs, a1);
		ActionListener a2 = new ActionListener(){public void actionPerformed(ActionEvent e){dessin.setCouleurArrierePlan(Color.red); dessin.repaint();}};
		ajoutItem("Rouge", menuCouleurs, a2);
		ActionListener a3 = new ActionListener(){public void actionPerformed(ActionEvent e){dessin.setCouleurArrierePlan(Color.green); dessin.repaint();}};
		ajoutItem("Vert", menuCouleurs, a3);

		JMenu menuFichier = new JMenu("Fichier");
		ActionListener a4 = new ActionListener(){public void actionPerformed(ActionEvent e){sauveGarder();}};
		ajoutItem("Sauvegarder en XML", menuFichier, a4);
		ActionListener a5 = new ActionListener(){public void actionPerformed(ActionEvent e){lireDepuisFichierXML();}};
	...
	private void creeBoutons(int largeur, int hauteur){
		...
		ActionListener a1 = new ActionListener(){public void actionPerformed(ActionEvent e){dessin.addBouleAleatoire(); dessin.repaint();}};
		fenetre.getContentPane().add(creeBouton("AjouterBoule",0,hauteur-80,largeur/2,40,a1));
		ActionListener a2 = new ActionListener(){public void actionPerformed(ActionEvent e){System.exit(0);}};
		fenetre.getContentPane().add(creeBouton("Quitter",largeur/2,hauteur-80,largeur/2,40,a2));
	}
	...
	public void sauveGarder(){
		// Sauvegarde des données dans un fichier XML inspiré par
	...
	public void lireDepuisFichierXML(){
        ...
        if (xml != null) {
             try {
                 // création d'un constructeur de documents à l'aide d'une fabrique
